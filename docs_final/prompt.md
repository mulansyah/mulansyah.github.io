...
Generate ONE Prompt Animate Image using exactly this structure:
...
[AUDIO CONTINUITY]
[VISUAL CONTINUITY]
to Prompt Animate Image as Extend fields.
...
Each selected duration must be explicitly specified in TIMING.
...
AC5: Prompt Animate Image uses only the specified ANIMATE IMAGE structure.
AC6: Prompt Animate Image duration is automatically selected between 3 and 10 seconds.
AC7: Prompt Extend 1 uses the specified EXTEND structure.
AC8: Prompt Extend 1 continues directly from Prompt Animate Image.
AC9: Prompt Extend 2 continues directly from Prompt Extend 1.
AC10: Every subsequent Prompt Extend continues directly from the immediately preceding stage.
AC11: Every Prompt Extend duration is automatically selected between 3 and 10 seconds.
AC12: Every selected duration is explicitly specified in TIMING.
AC13: Visual and audiovisual continuity is preserved.
AC14: Source-video information is not fabricated.
AC15: No stage in the approved flow is skipped or reordered.
AC16: No field, identifier, model, or approved structure is changed.
